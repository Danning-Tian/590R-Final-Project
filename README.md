This assignment include a quarto document, a data set called "cytomegalovirus.rda" that stores raw data, and a introduction of this data set downloaded from resource link.
